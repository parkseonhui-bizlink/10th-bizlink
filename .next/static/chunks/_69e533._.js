(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_69e533._.js", {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "History.useEffect": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
                __turbopack_require__("[project]/node_modules/gsap/index.js [app-client] (ecmascript, async loader)")(__turbopack_import__).then({
                    "History.useEffect": ({ default: gsap })=>{
                        __turbopack_require__("[project]/node_modules/gsap/ScrollTrigger.js [app-client] (ecmascript, async loader)")(__turbopack_import__).then({
                            "History.useEffect": ({ ScrollTrigger })=>{
                                gsap.registerPlugin(ScrollTrigger);
                                let sections = gsap.utils.toArray('.panel');
                                let container = document.querySelector('.container');
                                function updateScrollAnimation() {
                                    requestAnimationFrame({
                                        "History.useEffect.updateScrollAnimation": ()=>{
                                            if (!container) return;
                                            let totalWidth = sections.reduce({
                                                "History.useEffect.updateScrollAnimation.totalWidth": (acc, section)=>acc + section.getBoundingClientRect().width
                                            }["History.useEffect.updateScrollAnimation.totalWidth"], 0);
                                            container.style.width = `${totalWidth}px`;
                                            // 기존 ScrollTrigger 제거 후 다시 설정
                                            ScrollTrigger.getAll().forEach({
                                                "History.useEffect.updateScrollAnimation": (trigger)=>trigger.kill()
                                            }["History.useEffect.updateScrollAnimation"]);
                                            gsap.to(container, {
                                                x: {
                                                    "History.useEffect.updateScrollAnimation": ()=>-(totalWidth - window.innerWidth)
                                                }["History.useEffect.updateScrollAnimation"],
                                                ease: 'none',
                                                scrollTrigger: {
                                                    trigger: '.container',
                                                    ...
                                                    snap: {
                                                        snapTo: {
                                                            "History.useEffect.updateScrollAnimation": (progress)=>{
                                                                let sectionOffsets = sections.map({
                                                                    "History.useEffect.updateScrollAnimation.sectionOffsets": (s)=>s.offsetLeft / totalWidth
                                                                }["History.useEffect.updateScrollAnimation.sectionOffsets"]);
...
//# sourceMappingURL=_69e533._.js.map